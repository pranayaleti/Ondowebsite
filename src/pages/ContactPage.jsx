  ...
  return (
    <>
      <SEOHead
        ...
        description={`Contact ${companyInfo.name} for professional software development, freelancing services, and SaaS solutions. Get a free quote for your React, Node.js, Python, or Java project. Serving businesses across the USA. Call ${companyInfo.phoneDisplay} or email us today!`}
